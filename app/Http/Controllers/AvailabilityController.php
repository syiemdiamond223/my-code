...
class AvailabilityController extends Controller
{
    ...
    public function index()
    {
        ...
        $bookedDates = Availability::where('tutor_id', $tutor->id)
    ...
    public function toggle(int $id)
    {
        ...
        if ($hasBooking) {
            return back()->with('error', 'This slot already has bookings and cannot be changed.');
        }
    ...
    public function destroy(int $id)
    {
        ...
        if ($hasBooking) {
            return back()->with('error', 'Cannot delete a slot that already has bookings.');
        }
